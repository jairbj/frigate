...
from frigate.record.mixed import build_mixed_slices, find_gaps
...
class TestBuildMixedSlices(unittest.TestCase):
    """Verify the merged slice list against a real sqlite DB.
